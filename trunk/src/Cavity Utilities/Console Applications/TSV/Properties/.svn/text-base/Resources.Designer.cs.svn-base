...
namespace Cavity.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string TsvEntryCount {
            get {
                return ResourceManager.GetString("TsvEntryCount", resourceCulture);
            }
        }
        ...
        ///File:    {0}.
        /// </summary>
        internal static string TsvFileInfo {
            get {
                return ResourceManager.GetString("TsvFileInfo", resourceCulture);
            }
        }

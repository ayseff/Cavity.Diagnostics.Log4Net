...
namespace Cavity.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Converts data storage formats.
        ///
        ///Usage: DATA [/in:format] [/out:format] [/Q] names
        ///
        ///  names         Specifies a list of one or more files.
        ///                Wildcards may be used to process multiple files.
        ///
        ///  /in:format    Specifies the input format; overrides file extension.
        ///
        ///  /out:format   Specifies the output format; CSV if not specified.
        ///
        ///  /Q            Quiet mode; does not display file names while processing.
        ///
        ///Examples:
        ///                Process the example text file:
        ///		DATA /out:csv C:\Tem [rest of string was truncated]&quot;;.
        /// </summary>

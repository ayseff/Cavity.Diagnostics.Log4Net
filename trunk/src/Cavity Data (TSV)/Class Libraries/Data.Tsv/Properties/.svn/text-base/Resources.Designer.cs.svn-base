...
namespace Cavity.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string TsvStreamReader_ReadEntry_FormatException {
            get {
                return ResourceManager.GetString("TsvStreamReader_ReadEntry_FormatException", resourceCulture);
            }
        }
    }
}
